...
image:https://img.shields.io/npm/v/%40rben01%2Fcollagen[crates.io,link=https://www.npmjs.com/package/@rben01/collagen]
...
Install Collagen with `npm install -g collagen`.
