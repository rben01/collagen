			...
			svgSection.innerHTML = `
				<div class="svg-display">
					<div class="svg-controls">
						...
						<button class="control-btn reset-view" title="Reset View">↻</button>
						<button class="control-btn export-btn" title="Export SVG">💾</button>
					</div>
			...
			svgSection.innerHTML = `
				<div class="svg-display">
					<div class="svg-controls">
						...
						<button class="control-btn reset-view" aria-label="Reset view">↻</button>
						<button class="control-btn export-btn" aria-label="Export SVG">💾</button>
					</div>
