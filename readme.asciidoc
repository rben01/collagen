...
Here's (link:/examples/svgs/example-02.svg[the result^]) when you run `cargo run \-- -i example-02 -o example-02.svg`:
...
<2> It's not a meme unless it uses the Impact font.
